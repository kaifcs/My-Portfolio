    ...
    <section id="contact" className="py-16 px-4 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="space-y-8 lg:col-span-2 bg-zinc-950/40 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-6 hover:border-emerald-500/40 transition-all duration-300">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {/* GitHub */}
                <Link href="https://github.com/kaifcs" target="_blank" rel="noopener noreferrer" className="group">
                ...
                {/* LinkedIn */}
                <Link href="https://www.linkedin.com/in/kaif-khan-2805-2005-cs/" target="_blank" rel="noopener noreferrer" className="group">
                ...
                {/* Twitter/X */}
                <Link href="https://x.com/KaifKh2805" target="_blank" rel="noopener noreferrer" className="group">
          ...
          <div className="lg:sticky lg:top-24 lg:col-span-3">
            ...
            <div className="bg-zinc-950/40 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-6 hover:border-emerald-500/40 transition-all duration-300">
